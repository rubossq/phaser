...
var analytics = {
    ...
    sendRequest: function(data, callback){
        ...
        /*$.ajax({
            ...
            success: function(response){
                if(analytics.debug)
                    Log.d("ANALYTICS_OK", response);
                if(callback)
                    callback(true);
            },
            error: function(e){
                if(analytics.debug)
                    Log.d("ANALYTICS_FALSE", response);
                if(callback)
                    callback(false);
            }
        });*/

        this.najax(url, [], "POST", postData, function(result){
    ...
    najax: function(url, headers, method, params, callback){
        var xmlhttp;
